...
namespace PSPDFKit.Maui.Catalog.Examples.ViewModels
{
    public class ExportDocumentViewModel : ExampleViewModelBase
    {
        ...
        private readonly ExportOptionsPopupViewModel _optionsPopupViewModel;
        ...
        public ExportDocumentViewModel() : base("https://pspdfkit.com/guides/maui/save-a-document/")
        {
            ...
            _optionsPopupViewModel = new ExportOptionsPopupViewModel();

            SelectedDestination = DocumentSources.First();
        }

        public ICommand ExportCommand => _exportCommand;
        public ExportOptionsPopupViewModel OptionsPopupViewModel => _optionsPopupViewModel;
        ...
        private async Task OnExportToRemoteServerRequested()
        {
            ...
            HttpResponseMessage response = await client.PostAsync(SelectedDestination.DocumentSource.DocumentPath, form);
        ...
        private IExportConfiguration GetRequestedExportConfiguration()
        {
            ...
            exportConfiguration.ExcludeAnnotations = _optionsPopupViewModel.ExcludeAnnotations;
            exportConfiguration.ExportForPrinting = _optionsPopupViewModel.ExportForPrinting;
            exportConfiguration.ExportIncrementally = _optionsPopupViewModel.ExportForPrinting;
            exportConfiguration.Flatten = _optionsPopupViewModel.Flatten;
